...
\item Implement a function \haske{toMax}, that given a non-empty
  ...
  \end{hask}
  You can use the \haske{foo} function of problem (4e) if it helps.
 
  {\em BONUS: } Implement \haske{toMax} so that it only traverses
  a list once!
% 
\end{enumerate}
